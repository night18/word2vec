...
model = gensim.models.Doc2Vec(it, size = 300, window = 5,min_count=1, iter = 30) #alpha=0.025, min_alpha = 0.025
print(it)
# model.build_vocab()
...
# infer_vector = model.infer_vector(paragraphs[1])
# similar_documents = model.docvecs.most_similar([infer_vector], topn = 1)
# pprint(similar_documents[0][0])
